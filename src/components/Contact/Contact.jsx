...
export default function Contact() {
  return (
    <div className="max-w-3xl mx-auto px-4 mb-20  py-2">
      {/* Contact Card */}
      <div className="bg-[#07122d] p-8 rounded-2xl shadow-xl border border-white/10 text-center">
        ...
        <div className="mt-6 bg-white/5 py-3 px-5 rounded-xl border border-white/10">
      ...
      {/* Research Team */}
      <div className="bg-[#07122d] p-8 rounded-2xl shadow-xl border border-white/10 mt-10">
        <div className="flex justify-center mb-4">
